...
$string['allowpasswordinjection_help'] = 'When enabled, Proview acts as the authentication mechanism and the quiz password is automatically satisfied after the student passes the proctoring hardware check. Enable this only when the quiz password is used solely to gate access to the proctored flow — students will not be prompted to enter it manually.';
...
$string['proview_cdn_runtime_error'] = 'Proview could not be started because the configured CDN URL is missing or not trusted. Contact your site administrator and set a valid HTTPS URL on one of these hosts: {$a}.';
$string['proview_cdn_url'] = 'CDN URL';
$string['proview_cdn_url_desc'] = 'URL of the Proview JavaScript script injected into quiz pages to launch the proctoring session. HTTPS only, and host must be a trusted Talview CDN host.';
$string['proview_cdn_url_validation_error'] = 'Enter a valid HTTPS CDN URL on a trusted host: {$a}.';
