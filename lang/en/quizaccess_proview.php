...
$string['enable_sentry'] = 'Enable Sentry telemetry';
$string['enable_sentry_desc'] = 'When enabled, Proview sends plugin error and performance telemetry to Sentry for monitoring. Disabled by default.';
